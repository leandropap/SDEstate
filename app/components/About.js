    ...
    return (
        <section id='about' className="flex flex-row justify-around bg-sky-100 py-4">
            <div className="flex flex-col">
                <p className="text-xl font-medium pb-2">FAQ</p>
            ...
            <div className="flex flex-col">
                <p className="text-xl font-medium pb-2">Servicios</p>
            ...
            <div className="flex flex-col">
                <p className="text-xl font-medium pb-2">Novedades</p>
                <Link href='/last' className="hover:underline">Más recientes</Link>
