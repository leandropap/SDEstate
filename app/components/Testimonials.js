...
export default function Testimonials() {
    ...
    useEffect(() => {
        setData(createRandArray(json.testimonials))
    }, [])
        ...
        < section id='testimonials' className="py-8 px-4 bg-sky-50" >
            ...
            <div className="flex flex-row justify-evenly">
                {data.length ?
                    data.map(e => {
                        return (
                            <div className="border border-gray-400 rounded-xl mx-8 w-1/3 bg-white" key={e.name}>
                                <p className="text-justify text-lg px-4 py-4">&quot;{e.text}&quot; </p>
